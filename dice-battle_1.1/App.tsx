...
import { Trophy, RefreshCw, Zap, Sparkles, Wand2, Info, Flame, RotateCcw, Share2, Activity, ShieldAlert, Cpu, Globe } from 'lucide-react';
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-4 mb-4 z-10">
        ...
        <div className="w-full flex justify-between items-center px-1">
           <div className="flex items-center gap-1.5 px-2 py-0.5 bg-slate-900/50 rounded-full border border-slate-800">
              ...
              <span className="text-[7px] font-black text-slate-500 uppercase tracking-widest">Global Node: Active</span>
           </div>
           <div className="flex items-center gap-1">
              <Globe size={10} className="text-slate-700" />
              <span className="text-[7px] font-black text-slate-700 uppercase tracking-widest">v2.4.0 PROD</span>
           </div>
        </div>
